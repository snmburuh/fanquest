        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MpesaReceipt = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Completions_Participations_ParticipationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Completions_ParticipationId_ChallengeId",
                table: "Completions",
                columns: new[] { "ParticipationId", "ChallengeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Participations_UserId_QuestId",
                table: "Participations",
                columns: new[] { "UserId", "QuestId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Payments_MpesaReceipt",
                table: "Payments",
                column: "MpesaReceipt");
